									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											<span class="menu-link">
												...
												<span class="menu-title">CRUD Role</span>
												<span class="menu-arrow"></span>
											</span>
											<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link" href="/akuncreate">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link" href="{{route('akun.index')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">List Akun Admin</span>
													</a>
												</div>
											...
											<div class="menu-sub menu-sub-accordion menu-sub-lg-dropdown w-lg-225px px-lg-1 py-lg-4">
												<div class="menu-item">
													<a class="menu-link" href="{{route('akun.index')}}">
														...
														<span class="menu-title">List Akun Petugas</span>
													</a>
												</div>
										...
										<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-accordion">
											<span class="menu-link">
												...
												<span class="menu-title">Akun Masyarakat</span>
												<span class="menu-arrow"></span>
											</span>
											<div class="menu-sub menu-sub-accordion menu-sub-lg-dropdown w-lg-225px px-lg-1 py-lg-4">
												<div class="menu-item">
													<a class="menu-link" href="/listmasyarakat">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">List Akun Masyarakat</span>
													</a>
												</div>
