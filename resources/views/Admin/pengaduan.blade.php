										...
										<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$pengaduan->nik}}</a>
													...
													<td class="text-end">
														<a href="{{route ('pengaduan.edit', $pengaduan->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
