...
<head>
    <base href="../../../">
    <title>Pengaduan Masyarakat - Register Page</title>
        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sigma-1/14.png">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                ...
                <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form class="form w-100" id="kt_sign_up_form" action="{{route ('akun.update',$user->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input class="form-control form-control-lg form-control-solid" type="char" placeholder="" name="no_telp" autocomplete="off" />
                        </div>
