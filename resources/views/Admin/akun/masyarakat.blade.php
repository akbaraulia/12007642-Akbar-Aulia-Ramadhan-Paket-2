                    ...
                    <div class="header-container container-xxl">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
                            ...
                            <h1 class="d-flex flex-column text-dark fw-bolder my-1">
                                <span class="text-white fs-1">List Akun Masyarakat</span>
                                <small class="text-gray-600 fs-6 fw-normal pt-2">List Akun User Aplikasi Pengaduan Masyarakat</small>
                            </h1>
                            <!--end::Heading-->
                        </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <a href="#" class="fw-bold text-muted text-hover-primary fs-7">akbaraulia@gmail.com get data</a>
                                                </div>
                                                <!--end::Username-->
                                            </div>
                                        </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bolder fs-3 mb-1">List Masyarakat</span>
										<span class="text-muted mt-1 fw-bold fs-7">List Akun Masyarakat</span>
									</h3>
									<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
										...
										<!--end::Svg Icon-->Tambah Masyarakat</a>
													...
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="d-flex justify-content-start flex-column">
																<a href="#" class="text-dark fw-bolder text-hover-primary fs-6">Akbar Aulia Ramadhan</a>
																<span class="text-muted fw-bold text-muted d-block fs-7">akbaraulia@gmail.co.id</span>
															</div>
														</div>
													</td>
