                    ...
                    <div class="header-container container-xxl">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
                            ...
                            <h1 class="d-flex flex-column text-dark fw-bolder my-1">
                                <span class="text-white fs-1">List Akun Admin Dan Petugas</span>
                                <small class="text-gray-600 fs-6 fw-normal pt-2">List Akun Admin Dan Petugas Pengaduan Masyarakat</small>
                            </h1>
                            <!--end::Heading-->
                        </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-5"><?php echo Auth::user()->name?>
                                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2"><?php echo Auth::user()->role?></span></div>
                                                    <a href="#" class="fw-bold text-muted text-hover-primary fs-7"><?php echo Auth::user()->email?></a>
                                                </div>
                                                <!--end::Username-->
                                            </div>
                                        </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bolder fs-3 mb-1">List Admin Dan Petugas</span>
										<span class="text-muted mt-1 fw-bold fs-7">List Akun Admin Dan Petugas</span>
									</h3>
									<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
										<a href="/akuncreate" class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
