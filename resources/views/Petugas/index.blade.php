                                    ...
                                    <div class="col-6">
                                        <div class="card card-stretch">
                                            <a href="" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
												...
												<span class="fs-4 fw-bolder"> 1 </span>
                            ...
                            <div class="col-xl-8 ps-xl-12">
                                ...
                                <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-primary mb-5 mb-xl-8" style="background-position: 100% 50px;background-size: 500px auto;background-image:url('assets/media/misc/city.png')">
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-center">
                                        <!--begin::Title-->
                                        <h3 class="text-white fs-2x fw-bolder line-height-lg mb-5">Selamat Datang Petugas
                                            <br />Pengaduan Masyarakat</h3>
                                        <!--end::Title-->
                                        <!--begin::Action-->
                                        <div class="m-0">
                                            <a href='/pengaduanpetugas' class="btn btn-success fw-bold px-6 py-3" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Tinjau Pengaduan</a>
                                        </div>
                                        <!--begin::Action-->
                                    </div>
                                    <!--end::Body-->
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span class="text-muted fw-bold d-block">Masyarakat</span>
                                                                </td>
                                                                <td class="text-end text-muted fw-bold">Saya Di Begal Pulang Dari Masjid</td>
                                                                <td class="text-end">
