...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="page-bg-image-lg header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
		<!--begin::Main-->
		<!--begin::Root-->
						...
						<!--begin::Menu-->
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px" data-kt-menu="true">
								...
								<div class="menu-item px-3">
									<div class="menu-content fs-6 text-dark fw-bolder px-3 py-4">Kembali Ke Beranda</div>
								</div>
								<!--end::Menu item-->
						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<ul class="breadcrumb breadcrumb-line fw-bold fs-7 my-1">
									...
									<li class="breadcrumb-item text-gray-400">Contact Us</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
								...
								<div class="card-body p-lg-17">
									...
									<div class="row mb-3">
										...
										<div class="col-md-6 ps-lg-10">
											<!--begin::Map-->
											<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9985.494152444337!2d106.85723314721304!3d-6.678353519706521!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c905ec3922bd%3A0x9e7aa8cb6c82451!2sBalai%20Desa%20Banjarwangi!5e0!3m2!1sid!2sid!4v1677827311104!5m2!1sid!2sid" class="w-100 rounded mb-2 mb-lg-0 mt-2" style="height: 486px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
											<!--end::Map-->
										</div>
										<!--end::Col-->
									</div>
									...
									<div class="row g-5 mb-5 mb-lg-15">
										...
										<div class="col-sm-6 ps-lg-10">
											...
											<div class="text-center bg-light card-rounded d-flex flex-column justify-content-center p-10 h-lg-100">
												...
												<!--end::Icon-->
												<!--begin::Subtitle-->
												<h1 class="text-dark fw-bolder my-5">Kantor Pusat Kami</h1>
												<!--end::Subtitle-->
												<!--begin::Description-->
												<div class="text-gray-700 fs-3 fw-bold">Jl. Balai Desa, Banjar Wangi, Kec. Ciawi, Kabupaten Bogor, Jawa Barat 16720</div>
												<!--end::Description-->
											</div>
											<!--end::Address-->
										</div>
                    ...
                    <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                        ...
                        <ul class="menu menu-gray-600 menu-hover-primary fw-bold fs-6 fs-md-5 order-1 mb-5 mb-md-0">
                            ...
                            <li class="menu-item mx-5">
                                <a href="/" target="_blank" class="menu-link px-2">Beranda</a>
                            </li>
                            <li class="menu-item">
