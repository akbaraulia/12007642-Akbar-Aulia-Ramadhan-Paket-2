			...
			<div class="d-flex flex-column flex-xl-row flex-column-fluid">
				...
				<div class="flex-row-fluid d-flex flex-center justfiy-content-xl-first p-10">
					...
					<div class="d-flex flex-center p-15 shadow bg-body rounded w-100 w-md-550px mx-auto ms-xl-20">
						<!--begin::Form-->
						<form class="form" action="{{ route('pengaduan.store')}}" method="POST"
						 enctype="multipart/form-data">
							...
							<div class="fv-row mb-10">
								...
								<input class="form-control form-control-solid" type="text" placeholder="" name="nama_pelapor" autocomplete="off" />
							</div>
							<div class="fv-row mb-10">
                            ...
                            <div class="fv-row mb-10">
								...
								<input class="form-control form-control-solid" type="textarea" placeholder="" name="isi_laporan" autocomplete="off" />
							</div>
                            <div class="fv-row mb-10">
								<label class="form-label fw-bolder text-dark fs-6" style="display:none">Status</label>
								<input class="form-control form-control-solid" type="text" placeholder="" name="status" autocomplete="off" value="pengajuan" style="display:none"/>
							</div>
