...
<head>
    <base href="">
    <title>Pengaduan Masyarakat - Halaman Pengaduan</title>
...
<div class="card mb-5 mb-xl-8">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bolder fs-3 mb-1">Pengaduanmu</span>
										...
										<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
											...
											@foreach ($pengaduan as $pengaduan)
												<tr>
													...
													<td>
														<a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><img src="{{asset ('uploads/' . $pengaduan->foto)}}" width="300px;" height="300px:"></a>
													</td>
													...
													<td class="text-end">
                                                    <a href="/tanggapan">Tanggapanmu</a>
